...
INPUT_PATH = '/home/vboxuser/Desktop/MAESTRO-main_v2/sources/NMFSt/data/out/Trees'
DATA_OUTPUT_PATH = '/home/vboxuser/Desktop/MAESTRO-main_v2/sources/NMFSt/data/out/Subtrees'
...
for i in range(max_rows):
    ...
    for j in range(max_columns):
        print("=>Entrou i e j",i,j)
        dict_aux = {}
        for k in range(max_rows):
            print("=>Entrou k",i,j,k)
            for l in range(max_columns):
                print("=>Entrou l",i,j,k,l)
                if i != k:
